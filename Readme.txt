...
== HOW TO RUN:
   Go in src/ and type "ruby cuperativa_gui.rb"
...
== Versione 0.8.2 (8.11.2010)
- corretto salvataggio settings
- corretto carte prese nel tressette

== Versione 0.8.1 (27.10.2010)
- corretto errore gioco in rete
- migliorato il resize nel gioco della scopetta
- bugfix nella gestione delle animazioni carte giocate

== Versione 0.8.0 (14.10.2010)
- aggiunto il tressette
- forza giocatore computer nella scopetta
- migliorata finestra del gioco in rete

== Versione 0.7.5 (01.05.2010)
- briscolone
- nuova finestra compatta per ogni gioco
- effetti sonori durante le partite
...
== Forum ==
http://cuperativa.invido.it/forum

== Autore
Igor Sarzi Sartori

Home del progetto per i sorgenti
http://briscola.rubyforge.org

Gioco in rete
http://cuperativa.invido.it
